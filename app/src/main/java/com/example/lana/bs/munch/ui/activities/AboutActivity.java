...
import com.example.lana.bs.munch.models.LibraryItem;
import com.example.lana.bs.munch.models.SettingsPreferences;
import com.example.lana.bs.munch.ui.adapters.LibrariesRecyclerViewAdapter;
...
//            intent.setData(Uri.parse("market://details?id=com.example.lana.bs.munch"));
