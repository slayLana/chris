package com.example.lana.bs.munch.ui.activities;
...
import com.example.lana.bs.munch.sources.SourcesPresenter;
import com.example.lana.bs.munch.ui.adapters.CategoryListAdapter;
import com.example.lana.bs.munch.ui.fragments.FeedsFragment;
import com.example.lana.bs.munch.ui.fragments.ManageSourcesFragment;
import com.example.lana.bs.munch.utils.AnimationUtil;
import com.example.lana.bs.munch.utils.DateUtil;
import com.example.lana.bs.munch.utils.FadeAnimationUtil;
import com.example.lana.bs.munch.models.Categories;
import com.example.lana.bs.munch.models.CategoryItem;
import com.example.lana.bs.munch.sources.ISourceView;
import com.example.lana.bs.munch.ui.fragments.ArchiveFragment;
...
//            mNavPosition = 3;
    ...
    public void dataSourceSaveFailed(String message) {
        if (message.equals("name_url_category_empty")) {
            message = "源名称, url以及类别不能为空。";
            eTxtSourceName.setError("输入的名称不可用。");
            eTxtSourceUrl.setError("输入的URL不可用。");
        } else if (message.equals("name_empty")) {
            message = "名称不能为空。";
            eTxtSourceName.setError("请输入有效的名称。");
        } else if (message.equals("url_empty")) {
            message = "Url不能为空。";
            eTxtSourceUrl.setError("请输入有效的url");
